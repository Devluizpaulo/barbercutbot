...
-   **Status Atual**: O endpoint foi reativado e está pronto para receber notificações (`POST`). A lógica interna para processar cada tipo de evento (ex: `payment`, `subscription_preapproval`) ainda precisa ser implementada.
