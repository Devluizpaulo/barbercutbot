...
1. **Acesse seu projeto:**
   - https://console.cloud.google.com/compute/instances?project=barbercutbot
...
3. **Monitorar tráfego:**
   - https://console.cloud.google.com/networking/networkanalyzer?project=barbercutbot
